...
namespace CrocusoftProje.Identity.Auth
{
    public class UserManager : IUserManager
    {
        ...
        private readonly CrocusoftProjeSettings _settings;
        private readonly IClaimsManager _claimsManager;

        public UserManager(IUserQueries userQueries, IOptions<CrocusoftProjeSettings> settings, IClaimsManager claimsManager)
        {
