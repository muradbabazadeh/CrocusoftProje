    ...
    public class HttpGlobalExceptionFilter : IExceptionFilter
    {
        ...
        public void OnException(ExceptionContext context)
        {
            ...
            switch (exceptionType)
            {
                ...
                case var _ when exceptionType == typeof(Domain.Exceptions.DomainException):
                    {
                        var json = new JsonErrorResponse(nameof(Domain.Exceptions.DomainException), exception.Message, developerException);
                ...
                default:
                    {
                        ...
                        context.Result = new ActionResults.InternalServerErrorObjectResult(json);
